...
- この feature が共通設計書（DB設計・ファイル設計・共通データ設計）を参照すべきか
- feature 個別の `21_design.md` の中で、DBテーブル・ファイル形式・共通データ項目を新規定義しようとしていないか

共通設計書に未定義の設計が必要だと判断した場合は、`21_design.md` に勝手に書かず、作業報告に「共通設計書への追加候補」として記載してください。
...
- feature 個別の `21_design.md` にDBテーブル・ファイル形式・共通データ項目を新規定義しないでください
