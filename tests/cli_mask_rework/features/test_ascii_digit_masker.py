...
try:
    from cli_mask_rework.features.ascii_digit_masker import mask_ascii_digits
except ImportError as e:
    # Fallback: try relative import
    import importlib.util
    spec = importlib.util.spec_from_file_location(
        "ascii_digit_masker",
        Path(__file__).resolve().parent.parent.parent.parent / "src" / "cli_mask_rework" / "features" / "ascii_digit_masker.py"
    )
